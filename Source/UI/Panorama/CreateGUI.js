...
u8R"(
  ...
  var playerInfoTab = createSubTab(visuals, '玩家信息');
  ...
  createDropDown(playerOutlineGlow, "玩家发光", 'visuals', 'player_outline_glow', ['仅敌人', '所有人', '关']);
  ...
  createYesNoDropDown(bombAndDefuseKitOutlineGlow, "地上的炸弹发光", 'visuals', 'dropped_bomb_outline_glow');
  ...
  separator(playerModelGlow);
  separator(playerModelGlow);
  createHueSlider(playerModelGlow, "敌人的色调", 'player_model_glow_enemy_hue', 0, 359);
  separator(playerModelGlow);
  createHueSlider(playerModelGlow, "盟友的色调", 'player_model_glow_ally_hue', 0, 359);
  ...
  separator(bombModelGlow);
  separator(bombModelGlow);
  createHueSlider(bombModelGlow, "地上的炸弹色调", 'model_glow_dropped_bomb_hue', 0, 359);
  separator(bombModelGlow);
  createHueSlider(bombModelGlow, "已安装的炸弹色调", 'model_glow_ticking_bomb_hue', 0, 359);
  separator(bombModelGlow);
  createHueSlider(bombModelGlow, "地上的拆弹器色调", 'model_glow_defuse_kit_hue', 0, 359);
